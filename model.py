...
class BaseModel(object):
    ...
    def __init__(self, name, fn, model_path):
        ...
        the_optimizer = hypers.hyperparameters['optimization_algorithm'](lr=hypers.hyperparameters['learning_rate'], decay=hypers.hyperparameters['learning_rate_decay'])
        self.model.compile(the_optimizer, "categorical_crossentropy", ["accuracy"])

        self.path = model_path
        self.name = name
        self.load()

    def fit(self, train_data, valid_data, epochs=hypers.hyperparameters['epochs'], batchsize=hypers.hyperparameters['batch_size'], **kwargs):
        """Training function
